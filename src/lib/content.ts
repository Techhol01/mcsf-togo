...
export const EVENTS = [
  ...
  {
    id: "formation-missionnaires-2026",
    title: "Formation des Missionnaires",
    date: "2026-05-05",
    location: "Centre Rehoboth — Notse",
    status: "upcoming" as const,
    description: "Formation intensive pour équiper les nouveaux missionnaires appelés au champ de la moisson.",
    cover: eventVupj,
  },
  {
    id: "recyclage-ouvriers-2026",
    title: "Recyclage des Ouvriers",
    date: "2026-06-15",
    location: "MCSF Notse",
    status: "upcoming" as const,
    description: "Session de recyclage et de renouvellement spirituel pour les ouvriers en mission.",
    cover: eventConference,
  },
  {
    id: "formation-ouvriers-2026",
    title: "Formation des Ouvriers",
    date: "2026-07-02",
    location: "MCSF Notse",
    status: "upcoming" as const,
    description: "Enseignements approfondis pour les ouvriers de l'œuvre : doctrine, pastorale et évangélisation.",
    cover: eventVupj,
  },
  {
    id: "seminaire-leaders-2026",
    title: "Séminaire des Leaders",
    date: "2026-09-20",
    location: "MCSF Notse — Centre Rehoboth",
    status: "upcoming" as const,
    description: "Rencontre stratégique des leaders et responsables de cellules pour l'expansion de la mission.",
    cover: eventConference,
  },
  {
    id: "campagne-2025",
